...
* **Manual:** после включения настройки и появления записи в «Открывать при входе» пользователь подтвердил автоматический запуск на `Mac15,7`. Начальная видимость окна уточняется отдельно.
...
* **Manual pending:** проверить оба входа в собранном `.app`.
